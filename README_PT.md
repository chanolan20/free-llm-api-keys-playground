...
> ⏰ Última atualização: 2026-05-26 15:07 (UTC+8)
...
### DeepSeek `05-26 15:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-NefHSJuBmeK0eZGVCBBCsrGg20X7qWMq2mNmZ2M7pZpYsHrj` | deepseek-chat | 🆕 Nova | $9 | 20 RPM | 2026-05-28 | Everyday chat, coding, translation, writing |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `05-26 15:07`
...
### Image / Audio / Embedding `05-26 15:07`
