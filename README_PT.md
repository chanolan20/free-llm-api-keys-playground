...
> ⏰ Última atualização: 2026-06-06 18:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-06 18:30`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-YWwaHacyEiTJvQMXTk0Z1hhiUg2lyMhfOwyfhEiasbFKwDOS` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Kimi long-context general model |

### Image / Audio / Embedding `06-06 18:30`
